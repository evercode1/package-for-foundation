                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td>
                                <a href="/boomlet/{{row.Id}}">{{row.Name}}</a>
                            </td>
                            <td><a href="/boom/{{row.BoomId}}">{{ row.Boom }}</a></td>
                            <td>
                                {{row.Created }}
                            </td>
                            <td ><a href="/boomlet/{{row.Id}}/edit">
    ...
    export default {
        ...
        data: function () {
            ...
            return {
                ...
                query: '',
                gridColumns: ['Id', 'Name', 'Boom','Created'],
                gridData: [],
                total: null,
                next_page_url: null,
                prev_page_url: null,
        ...
        methods: {
            ...
            loadData: function (){
                $.getJSON('api/boomlet-data', function (data) {
                    ...
                    this.first_page_url = 'api/boomlet-data?page=1';
                    this.last_page_url = 'api/boomlet-data?page=' + this.last_page;
                    this.setPageNumbers();
                }.bind(this));
            },
                ...
                if (this.query == '' && getPage != null){
                    ...
                    if (getPage != null){
                        ...
                        $.getJSON(getPage, function (data) {
                            ...
                            this.first_page_url = 'api/boomlet-data?page=1&keyword=' +this.query;
                            this.last_page_url = 'api/boomlet-data?page=' + this.last_page + '&keyword=' +this.query;
                            this.current_page = data.current_page;
